#' A veto indice to measure the behaviour of of the winsorized weighted means
#'
...
#'
#' @return A numerical vector of the same length of weights. A veto indice measures the degree with which the behaviour of a criterion (coordenate of the vector to aggregate) is like a veto
#' @export
#'
#' @examples
#' veto_winsorized_weighted_mean(weights = rep(0.2,10), r=2, s=1)
veto_winsorized_weighted_mean<-function(weights, r, s=r, alpha=NULL, beta=alpha){
